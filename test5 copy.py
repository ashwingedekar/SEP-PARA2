            ...
            if not selected_data.empty:
                ...
                if flags.get("max") == '1':
                    ...
                    if id_value == '9619':
                        ...
                        elif max_speed_value <= upper_error_limit:

                            output_text += " MAX SPEED is within Upper Error Limit (1910 Mbit/s)\n\n"

                        elif max_speed_value <= upper_warning_limit:

                            output_text += " MAX SPEED is within Upper Warning Limit (1850 Mbit/s)\n\n"

                        else:

                            output_text += " MAX SPEED is out of control\n\n"
